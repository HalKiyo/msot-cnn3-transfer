...
def pretrained_load(inkey, outkey):
    ...
    outfile = f"/docker/mnt/d/research/D2/cnn3/predictand/continuous/{outkey}.npy"
...
def transfer_load(inkey, outkey):
    """
    ORAS5.shape = (57, 24, 72), 1958-2014
    aphro.shape = (65, 20, 20), 1951-2015
    """
    infile = f"/docker/mnt/d/research/D3/cnn3/transfer/predictors/{inkey}.npy"
    outfile = f"/docker/mnt/d/research/D3/cnn3/transfer/predictand/continuous/{outkey}.npy"
    predictors = np.load(infile)
    predictand = np.load(outfile)
    tors_reshaped = predictors[:, :, :]
    tand_rehsaped = predictand[7:64, :, :]
    return tors_reshaped, tand_rehsaped
...
def train_val_split(indata, outdata, train_num=32, val_num=25):
    ...
    validation: 1990-2014 (25years)
    train_period = 1958-1989
    validation_period = 1990-2014
    """
